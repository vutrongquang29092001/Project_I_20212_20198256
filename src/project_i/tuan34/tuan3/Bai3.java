...
public class Bai3 extends javax.swing.JPanel {
    ...
    public void handleJTextFiedlSetText() {
        ...
        Map<Integer, Integer> map = new Bai_3().bai_3(list);
        ...
        for (Integer key : set) {
            ...
            if (jTextField2.getText().equals("")) {
                jTextField2.setText(map.get(key) + "");
            }
        }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 150, 25));

        jLabel1.setText("jLabel1");
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 25, 150, 25));
